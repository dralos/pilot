    ...
    <div class="navbar mb-2 shadow-lg bg-neutral text-neutral-content">
        ...
        <div class="flex-1 px-2 mx-2">
            <div class="items-stretch hidden lg:flex">
                <router-link class="btn btn-ghost btn-sm rounded-btn" :to="{ name: 'home', params: { locale } }">
                    <font-awesome-icon icon="home" /> {{ t('home') }}
                </router-link>
                <router-link v-if="showAdminBoard" :to="{ name: 'admin', params: { locale } }" class="nav-link">
                    {{ t('adminBoard') }}
                </router-link>
                <router-link v-if="showModeratorBoard" :to="{ name: 'moderator', params: { locale } }" class="nav-link">
                    {{ t('moderatorBoard') }}
                </router-link>
                ...
                <router-link class="btn btn-ghost btn-sm rounded-btn" :to="{ name: 'cart', params: { locale } }">
                    {{ t('cart') }}
